...
//go:generate minimock -i github.com/Sane4eck55/CART-LOMS-COMMENTS-NOTIFIER/cart/internal/domain/service.ProductService -o product_service_mock.go -n ProductServiceMock -p mocks
...
type ProductServiceMock struct {
	...
	funcGetProductBySku          func(ctx context.Context, sku int64) (gp1 *model.GetProductResponse, err error)
...
func (mmGetProductBySku *mProductServiceMockGetProductBySku) Return(gp1 *model.GetProductResponse, err error) *ProductServiceMock {
	if mmGetProductBySku.mock.funcGetProductBySku != nil {
		mmGetProductBySku.mock.t.Fatalf("ProductServiceMock.GetProductBySku mock is already set by Set")
	}
	...
	mmGetProductBySku.defaultExpectation.results = &ProductServiceMockGetProductBySkuResults{gp1, err}
...
func (mmGetProductBySku *mProductServiceMockGetProductBySku) Set(f func(ctx context.Context, sku int64) (gp1 *model.GetProductResponse, err error)) *ProductServiceMock {
	if mmGetProductBySku.defaultExpectation != nil {
...
func (e *ProductServiceMockGetProductBySkuExpectation) Then(gp1 *model.GetProductResponse, err error) *ProductServiceMock {
	e.results = &ProductServiceMockGetProductBySkuResults{gp1, err}
	return e.mock
}
...
func (mmGetProductBySku *ProductServiceMock) GetProductBySku(ctx context.Context, sku int64) (gp1 *model.GetProductResponse, err error) {
